...
### Install
```
curl -L https://github.com/cdsap/ProjectGenerator/releases/download/v0.3.10/projectGenerator  --output projectGenerator
...
- `--gradle`: gradle_8_13, gradle_8_14_3, gradle_9_0_0, gradle_9_1_0, gradle_9_2_0, gradle_9_3_0 (default: gradle_9_3_0)
...
### Dependency
```
  implementation("io.github.cdsap:projectgenerator:0.3.10")
```
