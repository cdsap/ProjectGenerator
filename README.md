...
### Install
```
curl -L https://github.com/cdsap/ProjectGenerator/releases/download/v0.5.0/projectGenerator  --output projectGenerator
...
### Dependency
```
  implementation("io.github.cdsap:projectgenerator:0.5.0")
```
