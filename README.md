...
### Install
```
curl -L https://github.com/cdsap/ProjectGenerator/releases/download/v0.6.7/projectGenerator  --output projectGenerator
...
### Dependency
```
  implementation("io.github.cdsap:projectgenerator:0.6.7")
```
